module.exports = {
	...
	to_write_a_variable_name_use_the_convention:
		"Для написания имени переменной используйте соглашение",
	...
	staff_admin_crud:
		"Администратор персонала (Создание, Чтение, Обновление, Удаление)",
	...
	easily_add_and_manage_your_services:
		"Легко добавляйте и управляйте своими услугами",
	it_brings_together_your_invoice_clients_and_leads:
		"Он объединяет ваших клиентов и потенциальных клиентов по счетам",
	run_and_scale_your_erp_crm_apps:
		"Запускайте и масштабируйте ваши приложения ERP и CRM",
	people: "Люди",
	customize_this_application: "Настроить это приложение",
	do_you_need_help_on_customize_of_this_app:
		"Вам нужна помощь в настройке этого приложения",
	...
	crm_erp_tool_app_title:
		"Открытая ERP CRM Система Учета, Фактурирования и Управления Расходами",
	verify_your_account: "Подтвердите ваш аккаунт",
	complete_verification_by_providing_the_code_that_you_received_by_email:
		"Завершите проверку, предоставив код, который вы получили по электронной почте",
