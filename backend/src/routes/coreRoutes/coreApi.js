...
router
	.route("/admin/create")
	.post(hasPermission(), catchErrors(adminController.create));
router
	.route("/admin/read/:id")
...
router
	...
	.delete(hasPermission(), catchErrors(adminController.delete));
router
	.route("/admin/search")
	.get(hasPermission(), catchErrors(adminController.search));
router
	.route("/admin/list")
	.get(hasPermission(), catchErrors(adminController.list));
router
	.route("/admin/profile")
	.get(hasPermission(), catchErrors(adminController.profile));
router
	.route("/admin/status/:id")
	.patch(hasPermission(), catchErrors(adminController.status));
router
...
router
	...
	.post(hasPermission(), catchErrors(settingController.create));
router
	.route("/setting/read/:id")
	.get(hasPermission("read"), catchErrors(settingController.read));
router
...
router
	...
	.get(hasPermission(), catchErrors(settingController.search));
router
	.route("/setting/list")
	.get(hasPermission(), catchErrors(settingController.list));
router
	.route("/setting/listAll")
	.get(hasPermission("read"), catchErrors(settingController.listAll));
router
	.route("/setting/filter")
	.get(hasPermission(), catchErrors(settingController.filter));
router
...
router
	.route("/email/create")
	.post(hasPermission("create"), catchErrors(emailController.create));
router
	.route("/email/read/:id")
	.get(hasPermission("read"), catchErrors(emailController.read));
router
	.route("/email/update/:id")
	.patch(hasPermission("update"), catchErrors(emailController.update));
router
	.route("/email/search")
	.get(hasPermission("read"), catchErrors(emailController.search));
router
	.route("/email/list")
	.get(hasPermission("read"), catchErrors(emailController.list));
router
	.route("/email/listAll")
	.get(hasPermission("read"), catchErrors(emailController.listAll));
router
	.route("/email/filter")
	.get(hasPermission("read"), catchErrors(emailController.filter));
