...
const routerApp = (entity, controller) => {
	...
	router
		...
		.get(hasPermission("read"), catchErrors(controller.read));
	router
	...
	router
		.route(`/${entity}/search`)
		.get(hasPermission("read"), catchErrors(controller.search));
	router
		.route(`/${entity}/list`)
		.get(hasPermission("read"), catchErrors(controller.list));
	router
		.route(`/${entity}/listAll`)
		.get(hasPermission("read"), catchErrors(controller.listAll));
	router
		.route(`/${entity}/filter`)
		.get(hasPermission("read"), catchErrors(controller.filter));
	router
		.route(`/${entity}/summary`)
		.get(hasPermission("read"), catchErrors(controller.summary));
