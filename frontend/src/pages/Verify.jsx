	...
	return (
		<Loading isLoading={isLoading}>
			<Form form={form} layout="vertical" onFinish={onFinish}>
				...
				>
					<Select
						...
						options={[
							...
							{
								value: "Company (All kind of business)",
								label: "Company (All kind of business)",
							},
				...
				<Form.Item
					name="version"
					label="How you want to use CRM-ERP-Tool?"
					rules={[
						{
							required: true,
						},
				...
				>
					<Select
						...
						options={[
							{
								value: "online - one click deployment",
								label: "Online (one click deployment)",
							},
							{
								value: "Self-hosted",
							...
							{
								value: "Both : online and self-hosted",
								label: "Both : online and self-hosted",
							},
						]}
					/>
				</Form.Item>
				<Form.Item
					name="industry"
					label="In witch Industry you want use CRM-ERP-Tool?"
					rules={[
						{
							required: true,
						},
				...
				>
					<Select
						...
						options={[
							...
							{
								value: "non profit & charities",
								label: "non profit & charities",
							},
							...
							{ value: "Print & Edition", label: "Print & Edition" },
							{
...
const Verify = () => {
	...
	return (
		<Result
			...
			subTitle={translate(
				"Please answer those question to help us improve CRM-ERP-Tool",
			)}
			extra={
