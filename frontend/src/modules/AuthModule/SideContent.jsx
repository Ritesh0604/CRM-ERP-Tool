		...
		>
			<div style={{ width: "100%" }}>
				...
				<ul className="list-checked" style={{ paddingRight: 0 }}>
					<li
						className={`list-checked-item ${langDirection === "rtl" ? "list-checked-item-right" : "list-checked-item-left"}`}
					>
					...
					>
						<Space direction="vertical">
							<Text strong>
								{translate("Easily add and manage your services")}
							</Text>
							<Text>
								{translate("It brings together your invoice clients and leads")}
							</Text>
						</Space>
					</li>
				</ul>
