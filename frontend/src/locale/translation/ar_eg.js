const lang = {
	...
	to_write_a_variable_name_use_the_convention:
		"لكتابة اسم متغير، استخدم الاتفاقية",
	...
	it_brings_together_your_invoice_clients_and_leads:
		"يجمع بين عملائك وفواتيرك ومؤشراتك",
	...
	crm_erp_tool_app_title:
		"نظام إدارة موارد المؤسسات مفتوح المصدر لإدارة العلاقات مع العملاء والفواتير والمحاسبة والمصروفات",
	verify_your_account: "تحقق من حسابك",
	complete_verification_by_providing_the_code_that_you_received_by_email:
		"اكمل التحقق من خلال تقديم الرمز الذي تلقيته عبر البريد الإلكتروني",
